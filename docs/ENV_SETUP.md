...
SUPABASE_URL=...
SUPABASE_SERVICE_ROLE_KEY=...
# For Square OAuth signup and Connect Square
SQUARE_APPLICATION_ID=sq0idp-...       # Production
SQUARE_APPLICATION_SECRET=...          # Production (server-only)
SQUARE_SANDBOX_APPLICATION_ID=...      # Sandbox
SQUARE_SANDBOX_APPLICATION_SECRET=...  # Sandbox (server-only)
SQUARE_ENVIRONMENT=sandbox             # or 'production'
```
